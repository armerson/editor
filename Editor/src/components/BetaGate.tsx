    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 px-4">
      <div className="w-full max-w-sm rounded-2xl border border-neutral-800 bg-neutral-900 p-8 shadow-2xl">
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-neutral-400">{isSignIn ? "Sign in to continue" : "Create your account"}</p>
        </div>

        {/* Mode toggle */}
        <div className="mb-6 flex rounded-lg border border-neutral-700 p-1">
          <button
            type="button"
        ...
        <form onSubmit={isSignIn ? handleSignIn : handleRegister} className="space-y-4">
          ...
          {!isSignIn && (
            <div>
              <label htmlFor="login-confirm" className="mb-1.5 block text-xs font-medium text-neutral-300">
                Confirm password
              </label>
              <input
                id="login-confirm"
          ...
          <button
            type="submit"
            disabled={!email || !password || (!isSignIn && !confirmPassword) || loading}
