...
/**
 * Pass the editor's raw project JSON directly to Remotion as inputProps.
 *
 * The Remotion composition's calculateMetadata already calls
 * projectJsonToHighlightReelData() internally — it expects the raw project
 * shape (ProjectJson), not pre-adapted HighlightReelData. Adapting here would
 * cause a double-conversion where all field names come out wrong.
 */
